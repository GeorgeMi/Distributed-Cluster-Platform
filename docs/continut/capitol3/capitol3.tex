...
\begin{itemize}
    \item \textbf{PENDING}. The container needs to run, but no node currently has enough resources. It is created in the PENDING state.
